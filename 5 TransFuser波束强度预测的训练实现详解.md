...
对于某个波束索引，比如最佳波束索引是32，在模型预测的前三个最强波束索引（比如是34,32,31），都会考虑在DBA分数中 DBA分数与模型能力正相关。
DAB 分数考虑了预测波束与真实波束的距离，而不是简单的对错判断，是传统准确度判断的优化
![Uploading 9404f5fd272436e62843971959f8cfd.png…]()
